...
const PortionStyled = styled.div `
...
const SidebarItemIconStyled = styled.div `
    align-self   : center;
    justify-self : center;
    display      : grid;
    width        : 16px;
...
const SidebarItemTextStyled = styled.p `
    font-weight : 600;
    margin      : 0;
    line-height : 1;
`;
...
const SidebarSublinkGroupStyled = styled.div `
    margin           : 0;
...
const FormItemGroupStyled = styled.div `
    display        : flex;
    flex-direction : row;
    flex-wrap      : wrap;
    width          : 100%;
...
const FormItemJointGroupStyled = styled.div `
    display        : flex;
    flex-direction : row;
    flex-wrap      : wrap;
    width          : 100%;
...
const TextareaStyled = styled(InputFieldStyled) `
    max-width : 100%;
    min-width : 100%;
    resize    : vertical;
`;
...
`;
//  NOTIFICATIONS ITEM  =======================================================
const NotificationsItemStyled = styled.div `
    position         : relative;
    display          : flex;
    width            : 100%;
    height           : auto;
...
const BreadcrumbWrapperStyled = styled.nav `
    display          : flex;
    flex-direction   : row;
    flex-wrap        : wrap;
...
const ThemeProvider = (_a) => {
    ...
    return (React.createElement(Element, Object.assign({ as: ThemeProvider$1, theme: merge(RFTheme, theme) }, props),
        React.createElement(GlobalStyled, null),
        children));
};

export { BreadcrumbItem, BreadcrumbWrapper, Button, Card, CheckBox, CodeBlock, ContentWrapper, Element, FileUpload, FormItem, FormItemGroup, FormItemJointGroup, FormWrapper, HRule, Heading, InfoPanel, InputField, InputLabel, NotificationItem, NotificationWrapper, Portion, RadioButton, Row, Select, SidebarHeader, SidebarItem, SidebarItemIcon, SidebarItemText, SidebarSublinkGroup, SidebarWrapper, Switch, Table, Text, Textarea, ThemeProvider, baseColors };
